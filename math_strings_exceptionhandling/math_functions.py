...
print("log(1000,10)", math.log(1000))

#you can alo use base 10 like this
print("log10(1000) = ", math.log10(1000))

#We have the following trig fuctions
#sin(x), cos, tan, asin, atan, atan2, asinh, acosh
#atanh, sinh, cosh, tanh

#Convert radians to degrees and vice cersa
